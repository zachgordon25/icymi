...
class ShowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create show" do
    assert_difference('Show.count') do
      post shows_url, params: { show: { date: @show.date, img: @show.img, location: @show.location } }
    end
  ...
  test "should update show" do
    patch show_url(@show), params: { show: { date: @show.date, img: @show.img, location: @show.location } }
